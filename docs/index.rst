.. Golden-Retriever documentation master file, created by
   sphinx-quickstart on Thu Jun  4 16:45:51 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Golden-Retriever's documentation!
============================================
...
.. toctree::
   ...
   section/user-guide
   source/src.models_subpackages
   source/src.finetune
   source/src.data_handler
   source/api
